...
police <- fread("../figs/2014-11-11-police-complaints/police.csv")
...
police[,Complaint := factor(Complaint, levels = unique(police$Complaint))] # tidy more

policetotals <- police[Year == "2012/13",sum(number),by=Result]
policepresent <- copy(spread(police[Year == "2012/13"][,!c("Year","Major Category"),with=FALSE], Complaint, number))
